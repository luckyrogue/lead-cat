    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "rounded-(--cell-radius) [&>svg]:text-muted-foreground flex items-center gap-1 text-sm [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        month_grid: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "rounded-(--cell-radius) text-muted-foreground flex-1 select-none text-[0.8rem] font-normal",
        ...
        day: cn(
          "group/day rounded-(--cell-radius) [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius) relative aspect-square h-full w-full select-none p-0 text-center",
