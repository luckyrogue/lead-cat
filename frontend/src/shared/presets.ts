  ...
  nodes: [
    {
      id: "t1",
      type: "trigger.cron",
      parameters: { hour: 18, minute: 30, weekdays: [1, 2, 3, 4, 5] },
    },
    {
      id: "a1",
      type: "action.telegram.message",
      parameters: { text: "Пора коммитить! 🐾" },
    },
  ...
  nodes: [
    {
      id: "t1",
      type: "trigger.cron",
      parameters: { hour: 10, minute: 15, weekdays: [1, 3, 5] },
    },
    {
      id: "a1",
      type: "action.telegram.message",
      parameters: { text: "Созвон через 15 минут! 🐾 {{meet_link}}" },
    },
  ],
  ...
  nodes: [
    {
      id: "t1",
      type: "trigger.cron",
      parameters: { hour: 18, minute: 35, weekdays: [1, 2, 3, 4, 5] },
    },
