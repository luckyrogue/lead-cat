...
export const I18N = {
  ...
  kk: {
    ...
    noScenarios: "Сценарийлер жоқ",
    scenarioRun: "Іске қосу",
    scenarioRan: "Іске қосылды",
    scenarioRunFailed: "Іске қосу мүмкін болмады",
    scenarioToggleFailed: "Ауыстыру мүмкін болмады",
    auditLog: "Журнал",
    ...
    auditAction_scenario_toggled: "Сценарий ауыстырылды",
    auditAction_scenario_run_started: "Сценарий іске қосылды",
  },
  en: {
    _label: "English",
    _flag: "🇬🇧",
    ...
    scenarioRun: "Run",
    scenarioRan: "Started",
    scenarioRunFailed: "Could not run",
    scenarioToggleFailed: "Could not toggle",
    auditLog: "Audit log",
    ...
    auditAction_scenario_toggled: "Scenario toggled",
    auditAction_scenario_run_started: "Scenario run started",
  },
} as const
