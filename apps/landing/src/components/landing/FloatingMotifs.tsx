import { Paw, Sparkle, motion } from "@leadcat/ui";

const motifs = [
  { Comp: Paw, top: "12%", left: "6%", size: 46, color: "text-peach-300", dur: 7, delay: 0 },
  { Comp: Paw, top: "70%", left: "10%", size: 32, color: "text-coral-200", dur: 6, delay: 1.2 },
  { Comp: Sparkle, top: "22%", left: "88%", size: 28, color: "text-sunny-300", dur: 5, delay: 0.5 },
  { Comp: Paw, top: "82%", left: "84%", size: 40, color: "text-peach-300", dur: 8, delay: 0.8 },
