...
export type SurveyQuestionInput = Schemas["SurveyQuestionInput"]
export type SurveyInput = Schemas["SurveyInput"]
export type SurveyResponse = Schemas["SurveyResponse"]
export type SurveyAnswerValue = Schemas["SurveyAnswerValue"]
export type SurveysListResponse = Schemas["SurveysListResponse"]
export type SurveyResponsesListResponse = Schemas["SurveyResponsesListResponse"]
export type PublicSurveyView = Schemas["PublicSurveyView"]
export type PublicSurveyQuestion = Schemas["PublicSurveyQuestion"]
export type PublicSurveyAnswerInput = Schemas["PublicSurveyAnswerInput"]
export type PublicSurveySubmitRequest = Schemas["PublicSurveySubmitRequest"]
